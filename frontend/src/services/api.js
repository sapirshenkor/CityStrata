...
export const getPropertyListings = (params = {}) =>
  api.get('/api/property-listings', { params })
...
export const getPropertyListingUnitsTable = () =>
  api.get('/api/property-listings/units-table')
