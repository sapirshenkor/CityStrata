          ...
          <Popup>
            <div className="popup-content">
              ...
              {properties.full_address && (
                <p><strong>כתובת:</strong> {properties.full_address}</p>
              )}
              {properties.person_in_charge && (
                <p><strong>איש קשר:</strong> {properties.person_in_charge}</p>
              )}
              {properties.phone_number && (
                <p><strong>טלפון:</strong> {properties.phone_number}</p>
              )}
              {properties.activity_days && (
                <p><strong>ימי פעילות:</strong> {properties.activity_days}</p>
              )}
              {properties.facility_area && (
                <p><strong>שטח מתקן:</strong> {properties.facility_area} מ"ר</p>
              )}
              {properties.occupancy && (
                <p><strong>תפוסה:</strong> {properties.occupancy}</p>
              )}
              {properties.number_of_activity_rooms && (
                <p><strong>חדרי פעילות:</strong> {properties.number_of_activity_rooms}</p>
              )}
